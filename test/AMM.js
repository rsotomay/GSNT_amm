...
describe("AMM", () => {
  ...
  beforeEach(async () => {
    ...
    token1 = await Token.deploy("GASton Token", "GSNT", "1000000"); // 1 Million Tokens
  ...
  describe("Swapping tokens", () => {
    ...
    it("facilitates swaps", async () => {
      ...
      balance = await token1.balanceOf(liquidityProvider.address);
      console.log(
        `Liquidity Provider Token1 balance after removing fund: ${ethers.utils.formatEther(
          balance
        )} \n`
      );
      ...
      balance = await token2.balanceOf(liquidityProvider.address);
      console.log(
        `Liquidity Provider Token2 balance after removing fund: ${ethers.utils.formatEther(
          balance
        )} \n`
      );
