    ...
    <div>
      <Card style={{ maxWidth: "450px" }} className="mx-auto px-4">
        {account ? (
          ...
          >
            <Row className="my-3" style={{ color: "silver", fontSize: 18 }}>
              <div className="d-flex justify-content-between">
                <Form.Label>
                  <strong>Token to Give:</strong>
                </Form.Label>
                <Form.Text style={{ fontSize: 18 }}>
                  Balance:{" "}
            ...
            <Row className="my-4" style={{ color: "silver", fontSize: 18 }}>
              <div className="d-flex justify-content-between">
                <Form.Label>
                  <strong>Token to Get:</strong>
                </Form.Label>
                <Form.Text style={{ fontSize: 18 }}>
                  Balance:{" "}
          ...
          <p
            ...
            style={{ height: "300px", color: "silver", fontSize: 20 }}
          >
